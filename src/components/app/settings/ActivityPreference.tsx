...
export default function ActivityPreference() {
  ...
  return <section className="mt-6 rounded-2xl border border-aurora-border p-5">
    ...
    <p className="mt-2 text-sm opacity-70">On by default. Drift records which feature you used, the action and whether it worked, when it happened and how long it took, whether the app was in the foreground, and random session and action ids — linked to your account. No chat or search text, locations, or URLs. History is kept for up to 90 days after it reaches our servers. Turn this off to stop sharing and delete this usage history. Your trips and chats are unaffected.</p>
