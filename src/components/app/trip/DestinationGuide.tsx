...
export default function DestinationGuide({
  ...
  // A "Top things to do" polaroid was a plain <div>: the rail looked like a set
  // of cards and answered nothing you tapped. These are already resolved POIs,
  // so the detail sheet Discover uses opens straight from one.
