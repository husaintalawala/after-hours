...
export default function ChapterCard({ chapter, index, isActive }: ChapterCardProps) {
  ...
  return (
    <div ref={cardRef} className={"chapter-card p-6 md:p-8 max-w-lg w-full transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] mx-auto " + (isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4")}>
